import basic_func
from blinkt import clear, show, set_all #is this already taken from blinkt_functions?
import status
...
#     basic_func.solid_colour(light_color[0], light_color[1], light_color[2], current_status)
